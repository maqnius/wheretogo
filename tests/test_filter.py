...
appointments = [
    ("2019-05-16T12:00:00Z", "2019-05-16T14:00:00Z"),
    ("2019-05-17T19:00:00Z", "2019-05-17T21:00:00Z"),
]
...
test_events = [
    {
        ...
        "dates": {
            "start": {"dateTime": "2019-05-16T11:30:00Z"},
            "end": {"dateTime": "2019-05-16T13:30:00Z"},
        },
    },
    {
        "name": "EventB",  # Conflicts with first appointment (starts too early)
        "dates": {
            "start": {"dateTime": "2019-05-16T13:00:00Z"},
            "end": {"dateTime": "2019-05-16T14:30:00Z"},
        },
    },
    {
        "name": "EventC",  # No conflict
        "dates": {
            "start": {"dateTime": "2019-05-16T14:10:00Z"},
            "end": {"dateTime": "2019-05-16T14:30:00Z"},
        },
    },
    {
        ...
        "dates": {
            "start": {"dateTime": "2019-05-17T19:30:00Z"},
            "end": {"dateTime": "2019-05-17T20:00:00Z"},
        },
    },
]
...
def test_appointment_filter():
    ...
    # Cover all Events
    appointment_filter = TicketmasterAppointmentFilter(
        [("2019-05-15T11:30:00Z", "2019-05-18T13:30:00Z")]
    )
    filtered_events = appointment_filter(test_events)
