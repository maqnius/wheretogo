...
datetime_range = (
    today.isoformat(timespec="seconds") + "Z",
    tomorrow.isoformat(timespec="seconds") + "Z",
)
invalid_datetime_range = (
    yesterday.isoformat(timespec="seconds") + "Z",
    today.isoformat(timespec="seconds") + "Z",
)
appointments = [
    ("2019-05-22T12:00:00Z", "2019-05-22T14:00:00Z"),
    ("2019-05-22T19:00:00Z", "2019-05-22T21:00:00Z"),
]
...
def test_api_key():
    ...
    """
    url = os.path.join(ROOT_URL, "events.json")
...
def test_get_event_range(cached_api):
    ...
    filtered_events = cached_api.get_events(
        datetime_range, date_filter=long_appointment, city=query_params["city"]
    )
    ...
    filtered_events = cached_api.get_events(
        datetime_range, date_filter=appointment_filter, city=query_params["city"]
    )
